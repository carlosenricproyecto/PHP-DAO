    ...
    <div class="row">
        ...
        <div class="col-md-5">
            <div class="thumbnail menuthumb">
                ...
                <p class="menutext">List Mechanic</p>
            </div>
        </div>
        <div class="col-md-5">
            <div class="thumbnail menuthumb">
                <span class="glyphicon glyphicon-remove menuicon"></span>
                <p class="menutext">Delete Mechanic</p>
            </div>
        </div>
        <div class="col-md-1"></div>
        </div>
